            ...
            {allEvents.map((event, index) => {
              ...
              return (
                ...
                >
                  {hasPhases ? (
                    <>
                      {/* Phase segments with slow-fast gradient effect:
                          - Slow: gradual color transitions within each phase (multiple color stops)
                          - Fast: sharp transitions at phase boundaries (via CSS borders) */}
                      <div 
                        ...
                        style={{
                          ...
                          background: `linear-gradient(90deg, 
                            ${event.baseColors.start} 0%, 
                            ${event.baseColors.start} 10%,
                            ${event.baseColors.mid} 50%, 
                            ${event.baseColors.end} 90%,
                            ${event.baseColors.end} 100%
                          )`
                        }}
                      />
                      <div 
                        ...
                        style={{
                          ...
                          background: `linear-gradient(90deg, 
                            ${event.baseColors.start}e6 0%,
                            ${event.baseColors.start}e6 10%,
                            ${event.baseColors.mid}e6 50%,
                            ${event.baseColors.end}e6 90%,
                            ${event.baseColors.end}e6 100%
                          )`
                        }}
                      />
                      <div 
                        ...
                        style={{
                          ...
                          background: `linear-gradient(90deg, 
                            ${event.baseColors.start}b3 0%,
                            ${event.baseColors.start}b3 10%,
                            ${event.baseColors.mid}b3 50%,
                            ${event.baseColors.end}b3 90%,
                            ${event.baseColors.end}b3 100%
                          )`
                        }}
                      />
                      <div 
                        ...
                        style={{
                          ...
                          background: `linear-gradient(90deg, 
                            ${event.baseColors.start}80 0%,
                            ${event.baseColors.start}80 10%,
                            ${event.baseColors.mid}80 50%,
                            ${event.baseColors.end}80 90%,
                            ${event.baseColors.end}80 100%
                          )`
                        }}
                      />
